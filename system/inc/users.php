...
<font color="orange">Подтвержденные юзеры помечены оранжевым цветом</font>
...
<select name="mass_type" class="inpu" style="width:260px">
 ...
 <option value="17">Перевести в группу "Пользователи"</option>
  <option value="23">Подтвердить аккаунт</option>
 <option value="24">Снять подтверждение</option>
</select>
