...
$tpl->set('{user_real}', '');
			...
			if($user_id = $id){
				...
				if($user_img_fon['user_img_fon']){
					...
					$tpl->set('{url_img}', '<style type="text/css" media="all">back {background: url('.$img.') no-repeat center top fixed;margin:0px;padding:0px;font-size:11px;-moz-background-size:cover;-o-background-size:100% auto;-webkit-background-size:100% auto;-khtml-background-size:cover;background-size:cover;}</style>');
			} else {
