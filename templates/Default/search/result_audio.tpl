<div class="audio_onetrack" style="background:#fff;padding:15px;margin-left:0px;border-left:1px solid #e7e7e7;border-right:1px solid #e7e7e7;">
 ...
 <div class="clear"></div>
 <div class="player_mini_mbar fl_l no_display" style="margin-top:0px;" id="ppbarPro{jid}"></div> 
</div>