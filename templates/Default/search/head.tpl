...
$(document).ready(function(){
	...
	$(window).scroll(function(){
		if($(window).scrollTop() > 103)
			...
			$('.search_sotrt_tab').css('position', 'absolute').css('margin-top', '5px');
	});[/search-tab]
...
<input type="text" value="{query}" class="fave_input" id="query_full" 
	...
	style="width:760px;margin:0px;color:#000" 
maxlength="65" />
...
<div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="margin-top:10px;">
 <div class="{activetab-1}"><a href="/?{query-people}" onClick="Page.Go(this.href); return false;"><div>Люди</div></a></div>
 <div class="{activetab-4}"><a href="/?go=search{query-groups}" onClick="Page.Go(this.href); return false;"><div>Сообщества</div></a></div>
 <div class="{activetab-5}"><a href="/?go=search{query-audios}" onClick="Page.Go(this.href); return false;"><div>Аудиозаписи</div></a></div>
 <div class="{activetab-2}"><a href="/?go=search{query-videos}" onClick="Page.Go(this.href); return false;"><div>Видеозаписи</div></a></div>
 <div class="{activetab-3}"><a href="/?go=search{query-notes}" onClick="Page.Go(this.href); return false;"><div>Заметки</div></a></div>
</div>
