<div class="search_form_tab" style="margin-top:-9px">
 <div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond">
  ...
  <a href="/groups?act=admin" onClick="Page.Go(this.href); return false;"><div>Управление сообществами</div></a>
  <a href="/groups" onClick="groups.createbox(); return false"><div>Создать сообщество</div></a>
 </div>
</div>
