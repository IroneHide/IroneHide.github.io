[record]<div class="wallrecord wall_upage public_wall" id="wall_record_{rec-id}" style="padding-bottom:5px;">
  <div class="wan">
 <div class="ava_mini" id="ava_rec_{rec-id}"><a href="/{adres-id}" onClick="Page.Go(this.href); return false"><img src="{ava}" /></a></div>
 ...
 <div class="wall_tell_all cursor_pointer" onMouseOver="myhtml.title('{rec-id}', 'Отправить в сообщество или другу', 'wall_tell_all_')" onClick="Repost.Box('{rec-id}', 1); return false "id="wall_tell_all_{rec-id}" style="margin-top:0px;margin-right:7px;[owner]margin-top:2px;margin-right:8px[/owner]"></div>
  <div class="wallauthor" style="padding-left:0px"><a href="/{adres-id}" onClick="Page.Go(this.href); return false">{name}</a></div>
<a href="/wallgroups{public-id}_{rec-id}" onClick="Page.Go(this.href); return false" class="online">{date}</a>
 ...
 <div class="size10 infowalltext_f clear">
  ...
  <div class="fl_r public_wall_like cursor_pointer" style="margin-right:5px" onClick="{like-js-function}" onMouseOver="groups.wall_like_users_five('{rec-id}')" onMouseOut="groups.wall_like_users_five_hide('{rec-id}')" id="wall_like_link{rec-id}">
   <div class="fl_l" id="wall_like_active"></div>
      <b id="wall_like_cnt{rec-id}" style="float:right;font-size:14px;" class="{yes-like-color}">{likes}</b>
