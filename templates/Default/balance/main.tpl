<div class="search_form_tab" style="margin-top:-9px">
 <div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond">
  <div class="buttonsprofileSec"><a href="/balance" onClick="Page.Go(this.href); return false;"><div>Личный счёт</div></a></div>
  <a href="/balance?act=invite" onClick="Page.Go(this.href); return false;"><div>Пригласить друга</div></a>
...
<div class="button_div fl_l" style="line-height:15px;margin-left:172px;margin-top:15px"><button onClick="doLoad.data(2); payment.box()" style="width:161px">Пополнить баланс</button></div>
</div>