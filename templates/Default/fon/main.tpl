...
<div class="fon_facemy_add"><div class="fon_facemy_hidden" style="float:left;margin-right:10px;color: #0084b4;cursor:pointer;" onClick="fon_facemy.reload_facemy('{id}')"><b>Просмотреть</b></div>

<div id="upload_fon_facemy" style="float:left;color: #0084b4;"><b>Добавить облик</b></div>
