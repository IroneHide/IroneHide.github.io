...
[bottom]<span id="news"></span>
<div onClick="news.page()" id="wall_l_href_news" style="background:#E2E2E2;" class="cursor_pointer"><div class="photo_all_comm_bg wall_upgwi" id="loading_news" style="width:750px">Показать предыдущие новости</div></div>[/bottom]