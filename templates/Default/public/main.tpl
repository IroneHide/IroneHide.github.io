...
<div class="k1"">{title} {group_real}</div>
<div class="set_status_bg no_display" id="set_status_bg">
  ...
  [status]<div class="button_div fl_r status_but margin_left"><button>Отмена</button></div>[/status]
  <div class="button_div fl_r status_but"><button id="status_but" onClick="gStatus.set('', 1)">Сохранить</button></div>
 </div>
 <div class="status">
  <div><a href="/" id="new_status" onClick="gStatus.open(); return false">{status-text}</a></div>
...
<li><span class="tooltipss">
<a href="/" onClick="groups.loadphoto('{id}'); return false"><i class="icon-camera"></i></a><span class="classic">Загрузить фото</span></span>
</li>
<li><span class="tooltipss">
<a href="/" onClick="groups.delphoto('{id}'); return false;"><i class="icon-trash-1"></i></a><span class="classic">Удалить фото</span></span>
</li>
<li><span class="tooltipss">
<a href="/" onClick="groups.editform(); return false"><i class="icon-cog"></i></a><span class="classic">Редактировать группу</span></span>
</li>
<li><span class="tooltipss">
<a href="/" onClick="groups.inviteBox('{id}'); return false"><i class="icon-users-2"></i></a><span class="classic">Пригласить друга</span></span>
</li>
<li><span class="tooltipss tooltipss">
<a href="/stats?gid={id}"><i class="icon-calendar"></i></a><span class="classic">Статистика</span></span>
</li>
</ul>
</div>
...
<li class="co-act">
 <div id="yes" class="{yes}">
   <a href="#" class="co-ac" onClick="groups.login('{id}'); return false">Подписаться</i></a> 
    <div id="num2">{num-2}</div>
   </div>
</li>
<li class="co-act">
<div id="no" class="{no}">
   <a href="/public{id}" class="co-ac" onClick="groups.exit2('{id}', '{viewer-id}'); return false">Отписаться</i></a> 
   </div>
</li>
</ul>
</div>
...
[not-admin][cover] <div id="user-page-t1" class="clearfix rate_cntr" data-type="a"><div class="k1"">{title}</div><div class="status">{status-text}</div></div>

<div class="cover_all_user" style="margin-left:-15px;"><img src="{cover}" width="910" id="cover_img" {cover-param-5} /></div>[/cover][/not-admin]

<div class="ava fl_r" style="margin-right:0px" onMouseOver="groups.wall_like_users_five_hide()">

  <div class="{no-users}" id="users_block">
 <div class="garage-module">

   <div class="albtitle cursor_pointer" onClick="groups.all_people('{id}')">Подписчики
  ...
  [videos] <div class="garage-module"><div class="albtitle cursor_pointer" onClick="Page.Go('/public/videos{id}'); return false">Видеозаписи [yesvideo]{videos-num}[/yesvideo] [admin]<div style="float:right;cursor:pointer;"<a href="/public/videos{id}" onClick="Page.Go(this.href); return false">Добавить</a></div>[/admin]</div>
 <div class="publics" style="text-align: center;">
 {videos}
 ...
 [audios]<div class="garage-module"><div class="albtitle cursor_pointer" onClick="Page.Go('/public/audio{id}'); return false">Аудиозаписи [yesaudio]{audio-num} [/yesaudio]</div>
 <div class="publics">
  {audios}
 ...
 [feedback]<div class="garage-module"><div class="albtitle cursor_pointer" onClick="groups.allfeedbacklist('{id}')">Контакты [yes][admin]<a href="/public{id}" class="fl_r" onClick="groups.allfeedbacklist('{id}'); return false">ред.</a>[/admin][/yes]</div>
 <div class="publics" id="feddbackusers">
...
<div class="profiewr">
 ...
 <div class="fl_l" style="width:560px;font-size:14px;">
 ...
 [admin]<div class="public_editbg fl_l no_display" id="edittab1">
  ...
  <div class="texta">&nbsp;</div>
   ...
   <div class="button_div fl_l margin_left"><button onClick="groups.editformClose(); return false">Отмена</button></div>
  <div class="mgclr"></div>
 </div>
 ...
 [discussion]<div class="garage-module"><a href="/forum{id}" onClick="Page.Go(this.href); return false" class="fl_l" style="text-decoration:none"><div class="albtitle" style="border-bottom:0px">{forum-num} <div style="margin-left:5px" id="langForum">Нет обсуждений</div></div></a>
 <a href="/forum{id}?act=new" onClick="Page.Go(this.href); return false" class="fl_r {no}" style="text-decoration:none"><div class="albtitle" style="border-bottom:0px;">Новая тема</div></a>
 <div class="clear"></div>{thems}<div class="clear"></div></div>[/discussion]
 <div class="albtitle" style="border-bottom:1px dashed #dde5ed;">{rec-num}</div>
