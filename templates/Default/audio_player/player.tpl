...
<div id="Xjquery_jplayer"></div>
 ...
 <div class="staticpl_seachbg">
  <img src="{theme}/images/loading_mini.gif" class="fl_r no_display" id="jQpLoad" style="margin-left:660px;margin-top:13px;position:absolute" />
 ...
 <div class="staticpl_bottom">
  ...
  <a href="/audio{uid}" onClick="audio.addBox(); return false;" style="margin-left:10px">Добавить аудио</a>
