...
<input type="text" class="videos_input" placeholder="Введите заголовок" style="width:816px;font-size: 20px;line-height: 24px;height: 28px;" maxlength="65" id="title_n" value="{title}" />
