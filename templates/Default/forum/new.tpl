...
$(document).ready(function(){
 ...
 <div class="buttonsprofile albumsbuttonsprofile">
  ...
  <div class="buttonsprofileSec"><a href="/forum{id}?act=new" onClick="Page.Go(this.href); return false;"><div>Новая тема</div></a></div>
 </div>

<div class="clear"></div>
<div class="note_add_bg">
<div class="videos_text">Заголовок</div>
<input type="text" class="videos_input" style="width:815px;font-size: 20px;line-height: 24px;height: 28px;" maxlength="65" id="title_n" />
...
<div class="wall_attach fl_r" onClick="wall.attach_menu('open', this.id, 'wall_attach_menu')" onMouseOut="wall.attach_menu('close', this.id, 'wall_attach_menu')" id="wall_attach" style="margin-top:10px">Прикрепить</div>
 <div class="wall_attach_menu no_display" onMouseOver="wall.attach_menu('open', 'wall_attach', 'wall_attach_menu')" onMouseOut="wall.attach_menu('close', 'wall_attach', 'wall_attach_menu')" id="wall_attach_menu" style="margin-left:735px;margin-top:35px">
