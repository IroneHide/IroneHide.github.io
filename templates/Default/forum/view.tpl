...
<div class="search_form_tab" style="margin-top:-9px;background:#fff">
 <div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond">
  <a href="/public{id}" onClick="Page.Go(this.href); return false;"><div>К сообществу</div></a>
  <a href="/forum{id}" onClick="Page.Go(this.href); return false;"><div>Обсуждения</div></a>
  <div class="buttonsprofileSec"><a href="/forum{id}?act=view&id={fid}" onClick="Page.Go(this.href); return false;"><div>Просмотр темы</div></a></div>
...
<div class="note_full_title" style="margin-top:8px">
 ...
 <div class="clear" style="margin-top:-5px;margin-bottom:35px;line-height:14px">
   ...
   <div class="button_div fl_l margin_left" id="editClose"><button onClick="Forum.CloseEditTitle()">Отмена</button></div>
  </div>
 </div>
...
<div id="attach_block_vote" class="no_display" style="margin:auto;width:550px;margin-top:10px">
 <div class="attach_link_bg">
  ...
  <div class="clear" style="margin-top:25px;margin-bottom:40px;line-height:14px">
   ...
   <div class="button_div fl_l margin_left" id="editClose"><button onClick="$('#attach_block_vote').slideUp(100); Forum.RemoveForAttach()">Отмена</button></div>
  </div>
 <div class="clear"></div>
</div>
...
<div class="forum_text">
 ...
 <div class="no_display" id="editTextTab">
  ...
  <div class="clear" style="margin-top:10px;margin-bottom:40px;line-height:14px">
   ...
   <div class="button_div fl_l margin_left" id="editClose"><button onClick="Forum.CloseEdit()">Отмена</button></div>
  </div>
  <div class="clear"></div>
 </div>
...
<textarea 
	...
	id="fast_text_1" 
	style="width:800px;height:37px;color:#c1cad0;margin-left:3px;color:#000"
