<div class="search_form_tab" style="background:#fff;margin-top:-9px;margin: 0px;padding: 0px;">
...
<div class="note_text" style="height: 88px;border: 1px solid #e7e7e7;margin-top: 10px;">
...
<textarea 
	...
	id="answer" 
	style="width:812px;height:38px;color:#c1cad0"
