<div id="data">
<div class="search_form_tab" style="background:#fff;margin-top:-9px;padding:0px">
...
<div class="button_div fl_l margin_left" id="cancel"><button onClick="Page.Go('/u{uid}'); return false;">Отмена</button></div>
<div class="clear"></div>
</div>
[/not-group]
