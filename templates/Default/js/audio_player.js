...
var player = {
  ...
  change_list: function(uid){
    ...
    $('.staticpl_progress_bar').css('width', '500px');
    $('.staticpl_audios').css('width', '885px').css('height', '450px');
    $('.staticpl_shadow').css('width', '778px');
    $('#jQpSeachVal').css('width', '92%').css('float', 'left');
  ...
  reestablish: function(){
	...
	$('.staticPlbg').removeClass('page_audio').css('margin', '20px').css('margin-top', '60px').css('margin-left', pos+'px').css('margin-top', '-700px');
	$('.staticpl_progress_bar').css('width', '250px');
	$('.staticpl_audios').css('width', '700px').css('height', '340px');
	$('.staticpl_shadow').css('width', '459px');
	$('#jQpSeachVal').css('width', '650px').css('float', 'none');
