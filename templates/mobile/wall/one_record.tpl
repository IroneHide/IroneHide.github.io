...
<div class="panelsuvd"><a href="/" id="wall_like_link{rec-id}" onClick="{like-js-function}; return false" class="{yes-like-color}"></a>[owner]<a href="/" class="size10 fl_r" id="fast_del_{comm-id}" onClick="wall.delet('{rec-id}'); return false" style="font-weight:normal">Удалить</a>[/owner]</div>
